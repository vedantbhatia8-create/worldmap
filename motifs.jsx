// ── Shared travel motif components ───────────────────────────────────────────
  ...
  return (
    <svg style={{position:'absolute',inset:0,width:'100%',height:'100%',pointerEvents:'none',zIndex:0}} aria-hidden="true">
      <defs>
        ...
        <pattern id="mgrid-l" width="210" height="210" patternUnits="userSpaceOnUse">
          <path d="M 210 0 L 0 0 0 210" fill="none" stroke="rgba(110,95,56,0.18)" strokeWidth="1"/>
        </pattern>
      </defs>
      <rect width="100%" height="100%" fill="url(#mgrid)"/>
      <rect width="100%" height="100%" fill="url(#mgrid-l)"/>
    </svg>
  );
}
...
window.MotifGrid    = MotifGrid;
window.MotifStars   = MotifStars;
window.MotifCompass = MotifCompass;
window.MotifShip    = MotifShip;
window.MotifBalloon = MotifBalloon;
window.MotifPlane   = MotifPlane;
window.MotifPalm    = MotifPalm;
window.MotifAnchor  = MotifAnchor;
window.MotifScope   = MotifScope;
